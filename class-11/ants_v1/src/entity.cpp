...
auto Entity::update(const double time_delta, const Environment& environment, std::vector<Food>& food) -> void
{
    ...
    auto get_closest_food = [&](const Food& f1, const Food& f2) -> bool
        {
            // get the distance between the entity and f1, and the entity and f2,
